...
#Fuse Settings
FUSES      = -U lfuse:w:0xFF:m -U hfuse:w:0xD0:m -U efuse:w:0xFE:m
#-U hfuse:w:0xd8:m -U lfuse:w:0xef:m
#-U lfuse:w:0xFF:m -U hfuse:w:0xD0:m -U efuse:w:0xFE:m
...
altair: MCU = atmega256rfr2
altair: F_CPU = 16000000
altair: BOOTLOADER_ADDRESS = 3E000 
altair: CFLAGS += -D_BOARD_ALTAIR_256RFR2_ -DBAUDRATE=115200
altair: begin gccversion sizebefore build sizeafter end 
