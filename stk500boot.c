...
//* May 23, 2014	Rodrigo Méndez rmendez@makerlab.mx Edited to work with Altair board based on work by Meshthing (http://www.m9design.co)
//************************************************************************
...
#include	"command.h"
	...
	|| defined(__AVR_ATmega2561__) || defined(__AVR_ATmega1284P__) || defined(ENABLE_MONITOR) || defined( _BOARD_ALTAIR_256RFR2_ )
...
#define		BLINK_LED_WHILE_WAITING
	...
	#define PROGLED_DDR		DDRB
	#define PROGLED_PIN		PINB7
#elif defined( _BOARD_ALTAIR_256RFR2_ )
	#define PROGLED_PORT	PORTE
	#define PROGLED_DDR		DDRE
	#define PROGLED_PIN		PINE3
#else
...
#if defined(_BOARD_ALTAIR_256RFR2_)
...
//	boot_timeout	=	 10000;		//*	should be about 0.5 seconds
#else
